  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-64">
        <div className="text-gray-500 text-lg animate-pulse">Loading shops...</div>
      </div>
    )
  }
          ...
          >
            ...
            <div className="flex items-center p-4">
              <img
                src={shop.logo}
                alt={`${shop.name} logo`}
                className="w-14 h-14 rounded-full object-cover border-2 border-white shadow -mt-8 bg-white"
              />
              <div className="ml-4">
